...
:Description:
This module identifies the single-exposure image IDs
that were co-added to produce a stacked image (tile).
The image IDs are extracted from the tile FITS header.
