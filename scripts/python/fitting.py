...
def main():
    ...
    print("S/N:", res["s2n"])
    print(
        "true flux: %g meas flux: %g +/- %g (99.7%% conf)"
        % (
            obj_pars["flux"],
            res["flux"],
            res["flux_err"] * 3,
    ...
    print(
        "true g1: %g meas g1: %g +/- %g (99.7%% conf)"
        % (
            obj_pars["g1"],
            res["g"][0],
            res["g_err"][0] * 3,
    ...
    print(
        "true g2: %g meas g2: %g +/- %g (99.7%% conf)"
        % (
            obj_pars["g2"],
            res["g"][1],
            res["g_err"][1] * 3,
...
def get_args():
    ...
    parser.add_argument(
        "--show", action="store_true", help="show plot comparing model and data"
    )
    parser.add_argument("--noise", type=float, default=0.01, help="noise for images")
