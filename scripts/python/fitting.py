...
def main():
    ...
    psf_guesser = ngmix.guessers.TFluxGuesser(rng=rng,
        T=0.25,
        prior=prior,
        flux=100,
    ...
    print(res.keys())
    print(res['noshear'].keys())
    print('psf_options',obsdict['noshear'][0].weight.sum())
    #print('psf_options',obsdict['noshear'].psf.meta['result'].keys())
