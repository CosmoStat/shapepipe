...
#      full_var_list.extend(min_max_residuals_var_names)
   ...
   def create_histogram_plot(self, data_dico, var_name, var_bound, 
      ...
      if var_name in data_dico and len(data_dico[var_name]) > 0:
         ...
         var_mean = numpy.mean(data_dico[var_name])                
         var_std  = numpy.std(data_dico[var_name])                
         var_min  = numpy.min(data_dico[var_name])                
         var_max  = numpy.max(data_dico[var_name])                

         # --- Plot title and filename
         branch_tree = job.get_branch_tree()

         file_main, file_ext = os.path.splitext(file_type)
         plot_title = "{0} {1} - {2}.{3:03d}-{4:1d}{5} - "\
                      "Mean/Var: [{6:.2f}, {7:.2f}]  Min/Max: [{8:.2f}, {9:.2f}]".format(
                            var_name, tag, file_main, job.img_no, job.epoch, file_ext, 
   ...
   def create_scatter_plots(self, data_dico, info_dico, model_dico, 
      ...
      if "e1" in data_dico and "e2" in data_dico:      
         ...
         plot_title = "{0} {1} - {2}.{3:03d}-{4:1d}{5}".format(
                          e1_e2_label, tag, file_main, job.img_no, job.epoch, file_ext)
      ...
      if "SE_GAL_FWHM_IMAGE" in data_dico and "SE_GAL_FLUX_RADIUS" in data_dico:
         ...
         self.plot_scatter(data_dico, ["SE_GAL_FLUX_RADIUS", "SE_GAL_FWHM_IMAGE"],
                           plot_filename, plot_output_dir, plot_title=plot_title, 
                           pfilter=pfilter,
                           pxmin_lim=0, pxmax_lim=None, pymin_lim=0, pymax_lim=None, 
      ...
      # --- SE GAL_FLUX_RADIUS vs fitted disk hallh light radius
      ...
      if "sum_norm_residuals" in data_dico:      

         pfilter = numpy.logical_and(pfilter, numpy.asarray(data_dico["sum_norm_residuals"]) > 0.0)
         ...
         if "SE_GAL_FLUX" in data_dico:      
            ...
            self.plot_scatter(data_dico, ["SE_GAL_FLUX", "sum_norm_residuals"],
                              plot_filename, plot_output_dir, plot_title=plot_title, 
                              pfilter=pfilter,
                              pxmin_lim=0, pxmax_lim=None, pymin_lim=0, pymax_lim=None, 
                              x_label="SE Flux", y_label="Normalized Residuals / Pixel",  
                              pnorm=None, pcmap='jet', pcolor='b', pmarker='o', pmarkersize=4, 
                              pmarkerfacecolor=None, pmarkeredgecolor=None, 
                              px_sci=False, py_sci=False, pminor=True, pstats=False,
                              is_normed=False, has_equalaxes=False, has_grid=True, pfigure=None)
         ...
         if "SE_GAL_SNR" in data_dico:
            ...
            self.plot_scatter(data_dico, ["SE_GAL_SNR", "sum_norm_residuals"],
                              plot_filename, plot_output_dir, plot_title=plot_title, 
                              pfilter=pfilter,
                              pxmin_lim=0, pxmax_lim=None, pymin_lim=0, pymax_lim=None, 
                              x_label="SE SNR", y_label="Normalized Residuals / Pixel",  
                              pnorm=None, pcmap='jet', pcolor='b', pmarker='o', pmarkersize=4, 
                              pmarkerfacecolor=None, pmarkeredgecolor=None, 
                              px_sci=False, py_sci=False, pminor=True, pstats=False,
                              is_normed=False, has_equalaxes=False, has_grid=True, pfigure=None)
            ...
            if numpy.max(data_dico["sum_norm_residuals"]) > max_y_zoom_limit: 
               ...
               self.plot_scatter(data_dico, ["SE_GAL_SNR", "sum_norm_residuals"],
                                 plot_filename, plot_output_dir, plot_title=plot_title, 
                                 pfilter=pfilter,
                                 pxmin_lim=0, pxmax_lim=None, pymin_lim=0, pymax_lim=max_y_zoom_limit, 
                                 x_label="SE SNR", y_label="Normalized Residuals / Pixel",  
                                 pnorm=None, pcmap='jet', pcolor='b', pmarker='o', pmarkersize=4, 
                                 pmarkerfacecolor=None, pmarkeredgecolor=None, 
                                 px_sci=False, py_sci=False, pminor=True, pstats=False,
         ...
         if "SE_GAL_SNR" in data_dico:
            ...
            if numpy.max(data_dico["max_norm_residuals"]) > max_y_zoom_limit: 
               ...
               self.plot_scatter(data_dico, ["SE_GAL_SNR", "max_norm_residuals"],
                                 plot_filename, plot_output_dir, plot_title=plot_title, 
                                 pfilter=pfilter,
                                 pxmin_lim=0, pxmax_lim=None, 
                                 pymin_lim=0, pymax_lim=max_y_zoom_limit, 
                                 x_label="SE SNR", y_label="Maximum normalized Residuals / Pixel",  
                                 pnorm=None, pcmap='jet', pcolor='b', pmarker='o', pmarkersize=4, 
                                 pmarkerfacecolor=None, pmarkeredgecolor=None, 
                                 px_sci=False, py_sci=False, pminor=True, pstats=False,
