...
# -- External Modules
from mpfg.mp_args import *        # command line parsing and validation


# -------------------------------------------------------------------------------------------------
class WGfitArgs(Args):
   ...
   def print_usage(self, prog_name):
      ...
      print('\nOptions:')   
      print('-c,  --config-file\tconfiguration file name (default: wgfit.cfg)')    # wgfit
