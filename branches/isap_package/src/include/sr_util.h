...
void mr_support_filt(Ifloat img,Ifloat &img_filt, mr_opt opt,double nsig=6,int nb_iter=1,double*mse=NULL,Bool Pos_coeff=True,double lambda=1,Bool coarse_cons=False,Bool pos_cons=True, Bool drop_coarse=True,Bool iso_cons=False, double sig=89.108911);
