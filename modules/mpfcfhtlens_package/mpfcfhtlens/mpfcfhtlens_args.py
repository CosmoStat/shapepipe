"""! 
   @package mpfcfhtlens.mpfcfhtlens_args Command line option management
   @author Marc Gentile, Martin Kilbinger
   @file mpfcfhtlens_args.py
...
# -------------------------------------------------------------------------------------------------
class MpfcfhtlensArgs(MpfxArgs):
   ...
   def print_usage(self, prog_name):
      ...
      print('\nOptions:')   
      print('-c,  --config-file\tconfiguration file name (default: mpfcfhtlens.cfg)')
      print('-d,  --config-dir\tconfiguration directory (default: ./config)')
      print('\n')


# -- EOF mpfcfhtlens_args.py
