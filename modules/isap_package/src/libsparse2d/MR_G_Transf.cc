...
*******************************************************************************
**
** void transform_g (Ifloat &Imag, Ifloat &Imag_Out, int Nbr_Iter)
** 
** computes the G tranform of an image with Nbr_Iter oterations
**
*******************************************************************************
**
** void inverse_transform_g (Ifloat &Imag, Ifloat &Result, int Nbr_Iter)
**
** reconstruct an image from its G transform
**
***************************************************************************/ 

// static char sccsid[] = "@(#)MR_G_Transf.cc 3.1 96/05/02 CEA 1994 @(#)";
...
void transfo_g_one_scale (float *Imag, float *Imag_Out, int Nl, int Nc)
{
   int i,j;
   float *Ima_Aux, *Ima_Aux1;
   int Nl1,Nc1;
   Ima_Aux = new float [Nl*Nc];
   Ima_Aux1 = new float [Nl*Nc];
...
void transfo_g_inv_one_scale (float *Imag, float *Imag_Out, int Nl, int Nc)
{
   int i,j;
   float *Ima_Aux;
   float *Ima_Aux1;
