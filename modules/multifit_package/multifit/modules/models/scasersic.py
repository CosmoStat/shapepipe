...
class FittingModel(BaseFittingModel):
   ...
   def __init__(self, config_dir='./config/models', config_filename="scasersic.cfg"):
      """! 
         Construct a @c scasersic FittingModel object 
         @param config_dir configuration directory of the method
         @param config_filename name of the configuration file
      """  

      BaseFittingModel.__init__(self, name="scasersic", 
   ...
   def out_of_bound_handler(self):
      ...
      """
      #print "***MFIT: in scasersic, getting out_of_bound_handler()"
   ...
   def get_best_guess_params(self, coords, actual_galaxy_image, 
      ...
      for param in self.params:
         ...
         if param.guess_value is None:
            ...
            if param.name == "I0":   
               param.guess_value = numpy.max(actual_galaxy_image) # to refine to a box near center
   ...
   #      status = 0  # continue fitting
      ...
      #print "***MFIT: in scasersic out_of_bound handler", iiter, param, param_value, bound_index
   ...
   # -----------------------------------------------------------------------------------------------
   def scasersic(self, model, stamp_size, subscale, I0, n, re, e1, e2, xc, yc):
      """!
      ...
      # --- Return model Sersic profile with peak amplitude adjusted
      return  I0 * sersic_flux_array  
