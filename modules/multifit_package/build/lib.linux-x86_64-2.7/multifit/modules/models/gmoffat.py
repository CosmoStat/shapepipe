...
class FittingModel(BaseFittingModel):
   ...
   def __init__(self, config_dir='./config/models', config_filename="gmoffat.cfg"):
      """! 
         Construct a @c gmoffat FittingModel object 
         @param config_dir configuration directory of the method
         @param config_filename configuration directory of the method
      """  

      BaseFittingModel.__init__(self, name="gmoffat", 
   ...
   def out_of_bound_handler(self):
      ...
      """
      #print "***MFIT: gmoffat, getting  out_of_bound_handler..."
   ...
   def numerical_error_handler(self):
      ...
      """
      #print "***MFIT: gmoffat, getting  numerical_error_handler..."
...
#               param.guess_value = quad_e2
   ...
   #      status = 0  # continue fitting
      ...
      #print "***MFIT: in gmoffat out_of_bound handler", iiter, param, param_value, bound_index
  ...
  # -----------------------------------------------------------------------------------------------
   def gmoffat(self, model, stamp_size, subscale, I0, beta, FWHM, e1, e2, xc, yc):
      """!
      ...
      try:
         ...
         #print "***gmoffat:",  stamp_size, subscale, I0, beta, FWHM, e1, e2, xc, yc
         ...
         print("*** gmoffat model *** An error occurred: {0}".format(detail))
         #self.helper.print_error("gmoffat model: an error occurred: {0}".format(sys.exc_info()[1]))
