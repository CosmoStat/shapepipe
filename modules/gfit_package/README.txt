...
Download and untar the file gfit-2.0.2.tar.gz in the directory of your choice. 
The gfit executables are located in directory gfit-2.0.2/gfit. 
...
Refer to the HTML documentation in directory gfit-2.0.2/doc. The main entry point is index.html.
