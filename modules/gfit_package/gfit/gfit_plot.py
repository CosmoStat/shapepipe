            ...
            if value_names[iplot-1] in data_dico:
               ...
               if len(values) > 0:
                  ...
                  if pmin_xlim is None:
                     pmin_xlim = numpy.min(values)

                  if pmax_xlim is not None:
                     pmax_xlim = numpy.min(pmax_xlim, numpy.max(values))
                  else:
...
#                                 is_normed=False, has_equalaxes=False, has_grid=True, pfigure=None)
         ...
         # --- Residuals vs dre
         if "dre" in data_dico and "sum_norm_residuals" in data_dico:      #FCS ADDED  and "sum_norm_residuals" in data_dico:
         ...
         # --- Residuals vs bre
         if "bre" in data_dico and "sum_norm_residuals" in data_dico:      #FCS ADDED  and "sum_norm_residuals" in data_dico:
