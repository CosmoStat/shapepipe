"""! 
   @package mpfcs82.mpfcs82_data Dataset management
   @author Marc Gentile
   @file mpfcs82_data.py
   Dataset management
"""
...
# -------------------------------------------------------------------------------------------------
class MpfCS82Dataset(MpfxDataset):
...
# -------------------------------------------------------------------------------------------------
class MpfCS82MultiEpochDataset(MpfxMultiEpochDataset):
