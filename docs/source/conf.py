...
latex_documents = [
    (master_doc, 'ShapePipe.tex', 'ShapePipe Documentation',
     'Samuel Farrens', 'manual'),
]
...
man_pages = [
    (master_doc, 'shapepipe', 'ShapePipe Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ShapePipe', 'ShapePipe Documentation',
     author, 'ShapePipe', 'One line description of project.',
     'Miscellaneous'),
]
