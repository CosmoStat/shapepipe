...
```bash
apptainer pull shapepipe_im_sims.sif docker://ghcr.io/cosmostat/shapepipe:im_sims-runtime
```
...
Run jobs
```bash
run_job_sp_canfar_v2.0.bash -e 233.293 -t image_sims -j <job>
```

Help
```bash
run_job_sp_canfar_v2.0.bash -h
```
