...
```bash
cfis_field_select -i /path/to/shapepipe/aux/CFIS/tiles_202007/tiles_all_order.txt --coord 255.66deg_34.05deg -t tile --input_format ID_only --out_name_only --out_ID_only -s -o tile_numbers
```
