...
Simple Coordinate Descent Minimizer 

Author: Marc Gentile (marc.gentile@epfl.ch)

This is a simple minimizer based on a coordinate-descent algorithm
...
Download and unpack the file scdm-0.6.1.tar.gz in the directory of your
...
procedure: 
     ...
     2. cd to the directory where scdm-0.6.1.tar.gz was unpacked
