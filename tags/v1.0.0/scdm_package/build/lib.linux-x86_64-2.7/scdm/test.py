...
param1 = Param(name='param1', param_range=[None, None], guess_value= 1,  step_size=1e-1, step_range=[None, 1e-1], step_factor=2, max_tol=1e-8)
param2 = Param(name='param2', param_range=[None, None], guess_value= 1,  step_size=1e-1, step_range=[None, 1e-1], step_factor=2, max_tol=1e-8)
param3 = Param(name='param3', param_range=[None, None], guess_value= 1,  step_size=1e-1, step_range=[None, 1e-1], step_factor=2, max_tol=1e-8)
...
fitting_options = FittingOptions(max_iter=20000, max_fev=50000, max_func_tol=1e-10, all_minima=False, mini_type=minimization_type)
...
#diag_options = DiagOptions(diagFlags=DiagFlag.logs, base_output_directory=base_output_directory)
